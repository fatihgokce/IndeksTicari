...
namespace Indeks.Views {
    public partial class frmCekRapor : Form {
        ...
        void LoadGrid() {
            try {
                ...
                _source = _mngCek.CekRaporu(UserInfo.Sube.Id,
                ...
                _source.Replace("CekTip", "0", "Verilen");
                _source.Replace("CekTip", "1", "Alınan");
                _source.Replace("CekDurum", "1", "Beklemede");
                _source.Replace("CekDurum", "2", "TahsilEdildi");
                _source.Replace("CekDurum", "3", "CiroEdildi");
                _source.Replace("CekDurum", "4", "BankayaTahsileVerildi");
                _source.Replace("CekDurum", "5", "TahsilBankaHesaba");
                _source.Replace("CekDurum", "5", "IadeEdildi");
                _source.Replace("CekDurum", "6", "BankaTeminatVerildi");        
                _source.Replace("CekDurum", "7", "Karşılıksız");
                _source.Replace("CekDurum", "8", "Ödendi");
                _source.Replace("CekDurum", "9", "GeriAlindı");
